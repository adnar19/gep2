...
if (enregistrement.id_groupe == filtreParGroupe || filtreParGroupe == '0') html +=  '<tr data-id="'+enregistrement.id+'"  onclick="selectionner(this)"><td>'+enregistrement.id+'</td><td>'+enregistrement.infosGroupe+'</td><td>'+enregistrement.infosEtudiant+'</td><td>'+enregistrement.date+'</td><td>'+enregistrement.carte+'</td><td>'+enregistrement.nbr_s+'</td><td>'+enregistrement.derniere_s+'</td></tr>';
